            ...
            if isinstance(parts, list):
                ...
                for part in parts:
                    if isinstance(part, str):
                        ...
                        text_parts.append(extract_text_from_content(part['content']))
...
def main():
    parser = argparse.ArgumentParser(description='Generate Canonical Sentence IDs for ChatGPT conversations')
    ...
    print('🔍 Processing conversations for sentence and word ID generation...')
    ...
    sentences_output = os.path.join(args.output, 'sentences.csv')
    occurrences_output = os.path.join(args.output, 'sentence_occurrences.csv')
    words_output = os.path.join(args.output, 'words.csv')
